jest.mock('react-native-device-info', () => {
  ...
  const english = require('@stravels/i18n/languages/english.json')
...
// Note: added to fix test in RN48
// See https://github.com/facebook/react-native/issues/15810
...
const mockNativeModules = {
  ...
  PushNotificationManager: {
    ...
    getApplicationIconBadgeNumber: jest.fn(cbk => process.nextTick(() => cbk(0))),
    ...
    checkPermissions: jest.fn(cbk => process.nextTick(() => cbk({alert: true, badge: true, sound: true}))),
